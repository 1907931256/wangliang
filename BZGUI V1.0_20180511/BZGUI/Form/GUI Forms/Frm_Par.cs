...
namespace BZGUI
{
    public partial class Frm_Par
    {
        ...
        private void Frm_Par_Load(object sender, EventArgs e)
        {
            ...
            txt_PickCCDErrCounts.Text = BVar.FileRorW.ReadINI("ErrStatistics", "PickCCDErr", System.Convert.ToString(0), PVar.BZ_ErrStatisticsPath);
            txt_PickErrCounts.Text = BVar.FileRorW.ReadINI("ErrStatistics", "PickErr", System.Convert.ToString(0), PVar.BZ_ErrStatisticsPath);
            txt_HsgSnErrCounts.Text = BVar.FileRorW.ReadINI("ErrStatistics", "HsgSnErr", System.Convert.ToString(0), PVar.BZ_ErrStatisticsPath);
            txt_HsgErrCounts.Text = BVar.FileRorW.ReadINI("ErrStatistics", "HsgErr", System.Convert.ToString(0), PVar.BZ_ErrStatisticsPath);
            txt_MEMErrCounts.Text = BVar.FileRorW.ReadINI("ErrStatistics", "MEMErrCounts", System.Convert.ToString(0), PVar.BZ_ErrStatisticsPath);
        ...
        public void Par_Clear()
        {
            ...
            txt_PickCCDErrCounts.Text = System.Convert.ToString(PVar.PickCCDErrCounts);
            txt_PickErrCounts.Text = System.Convert.ToString(PVar.PickErrCounts);
            txt_HsgSnErrCounts.Text = System.Convert.ToString(PVar.HsgSnErrCounts);
            txt_HsgErrCounts.Text = System.Convert.ToString(PVar.HsgErrCounts);
            txt_MEMErrCounts.Text = System.Convert.ToString(PVar.MEMErrCounts);
        ...
        private void Btn_ParSave_Click_1(object sender, EventArgs e)
        {
