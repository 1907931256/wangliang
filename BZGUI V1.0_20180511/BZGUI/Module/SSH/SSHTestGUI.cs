...
namespace BZGUI
{
    public partial class SSHTestGUI : Form
    {
        ...
        private void SSHTestGUI_FormClosed(object sender, FormClosedEventArgs e)
        {
        ...
        {
            if (isConn)
                SSH.Instance.ExecuteCommand("multiview --preampcal");
        }

        private void btn_Step2_Click(object sender, EventArgs e)
        {
            if (isConn)
                SSH.Instance.ExecuteCommand("0");
        }
