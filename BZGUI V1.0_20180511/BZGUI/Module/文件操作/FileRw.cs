...
#region 功能：连接数据库
		public static dynamic DataBaseConn(string strPathFileFolder)
		{
			try
			{
				string str = "Provider=Microsoft.JET.OLEDB.4.0;Data Source=" + strPathFileFolder + "; Jet OLEDB:database Password=123456;";
...
#region 曲线图
        ...
        public static void DeleteFile(string path)
        {
            try
            {
                System.IO.FileAttributes fab = File.GetAttributes(path);
                if (fab == System.IO.FileAttributes.Directory)
