		...
		public DataViewInfo1[] AlarmViewInfo = new DataViewInfo1[] {
			...
			public void LoadAlarmHistoryData(DateTime FirstDay, DateTime LastDay)
			{
                ...
                tmpDate = System.Convert.ToString(DateAndTime.DateAdd("d", System.Convert.ToDouble(-i), LastDay).ToString("yyyyMMdd"));
					tmpNum = int.Parse(BVar.FileRorW.ReadINI(tmpDate, "TotalAlarmNum", "0", "D:\\BZ-Parameter\\DAB\\AlarmHistoryData.ini"));
					if (tmpNum <= 0)
					{
						continue;
					}
					...
					{
						tmpString = BVar.FileRorW.ReadINI(tmpDate, "Alarm" + (j).ToString(), "00:00:00,00:00:00,F0000,Not Known", "D:\\BZ-Parameter\\DAB\\AlarmHistoryData.ini");
				...
				for (var i = 30; i <= 50; i++)
				{
                BVar.FileRorW.DelIniSec(System.Convert.ToString(DateAndTime.DateAdd("d", System.Convert.ToDouble(-i), DateTime.Now.Date).ToString("yyyyMMdd")), "D:\\BZ-Parameter\\DAB\\AlarmHistoryData.ini");
				}
