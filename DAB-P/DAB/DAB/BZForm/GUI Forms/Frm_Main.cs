...
namespace DAB
    ...
    public partial class Frm_Main
        {
        public AutoSizeFormClass aT = new AutoSizeFormClass();
        ...
        public Frm_Main()
            ...
            InitializeComponent();
            fMain = this;
            aT.controllInitializeSize(this);
            }
        ...
        private dynamic IsNotShow(string frmName)
            ...
            foreach (Form Fr in Application.OpenForms)
                ...
                if (Fr.Name != ActiveFrmNme && Fr.Name != "Frm_Main" && Fr.Name != "Frm_Login" && Fr.Name != "Frm_Dialog")
                    ...
                    if (Fr.Name == "Frm_RunInfo" || Fr.Name == "Frm_AlarmInfo" || Fr.Name == "Frm_MachineInfo" || Fr.Name == "Frm_Par" || Fr.Name == "Frm_Par_CCD")
                        {
                        Fr.Close();
                        break;
                        }
        ...
        private void Btn_Login_Click(object sender, EventArgs e)
            ...
            if (MainUserName.Text == "Administrator" && MainPassword.Text=="zhanzw314177011")
                {
            ...
            if (MainUserName.Text == "OP")
                {
                Frm_Engineering.fEngineering.TabPage3.Parent = null;
                Frm_Engineering.fEngineering.TabPage4.Parent = null;
                FunctionSub.Close_NumberKey_Process();
                Frm_Engineering.fEngineering.Show(this);
                PVar.IsOpenFrmEngineering = true;
                this.BackColor = Color.White;
        ...
        private void Btn_Start_Click(object sender, EventArgs e)
            ...
            if (GoHome.Reset.Result == false && PVar.IsLoadFrmEngineering == true)
                {
            ...
            else if (GoHome.Reset.Result == true && PVar.IsLoadFrmEngineering == true)
                {
                    ...
                    if (PVar.ParList.CheckSts[17])
                        ...
                        if (strin.Length > 0)
                            ...
                            if (strin == "1234")
                                ...
                                {
                                Interaction.MsgBox("     密码错误！", Constants.vbOKOnly, "提示");
                                return;
                                }
                            }
                        else
        ...
        public void Btn_StopFun()
            ...
            if (PVar.Sta_Work[0].Step > 10 || PVar.Sta_Work[1].Step > 10 || PVar.Sta_Work[2].Step > 10 || PVar.Sta_Work[3].Step > 10 || PVar.Sta_Work[4].Step > 10)
                {
        ...
        private void Close_TCP()
            ...
            try
                {
                Frm_Engineering.fEngineering.Tcp_CCD.StopConnect();
                ...
                Frm_Engineering.fEngineering.Tcp_RobotData.StopConnect();
                Frm_Engineering.fEngineering.Tcp_Barcode.StopConnect();
                }
            catch (Exception)
                {
